...
let scenarios: [TextScenarios] = [
    TextScenarios(
        ...
        , imageName: "img_level_1" // ← سمه زي ما تبغى
    ),
    TextScenarios(
        level: 2,
        description: "زميلك اليوم ساكت مو مثل عادته، ما دخل معكم لا بنقاش ولا حتى وقت الغداء. وش ممكن تسوي؟",
        choices: [
        ...
        , imageName: "img_level_2" // ← سمه زي ما تبغى
    ),
    TextScenarios(
        level: 3,
        description: "مديرك قال: شغلك ممتاز، بس عندي ملاحظات ، و زميلك الأصغر قال: اعتقد انه هناك جوانب تحتاج إلى تحسين",
        choices: [
            Choice(text: "تسمع لملاحظات مديرك وتقول له: \"شكرًا على الملاحظات، أكيد بشتغل عليها\"، وترد على زميلك: أقدر رأيك.", points: 10),
            Choice(text: "توضح لمديرك وجهة نظرك في الملاحظات وترد على زميلك بكلام عام.", points: 5),
            Choice(text: "تاخذ ملاحظات مديرك وبالنسبة لزميلك تقول له: \"الشغل كويس\" بدون تفاصيل.", points: 1)
        ]
        , imageName: "img_level_3_7" // ← سمه زي ما تبغى
    ),
    TextScenarios(
        level: 4,
        ...
        ,imageName: "img_level_4" // ← سمه زي ما تبغى
    ),
    TextScenarios(
        level: 5,
